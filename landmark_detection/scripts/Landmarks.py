...
class Landmarks:
    ...
    def search_landmark(self, point, obj_class):
        ...
        for i in range(len(self.landmarks)):
            ...
            if dist < min_dist and self.landmarks_classification[i] == obj_class:
                min_dist = dist
                min_id = i
        return min_id
    ...
    # Inputs:
    # point: np.array of 3x1
    def add_landmark(self, point, obj_class):
        self.landmarks.append(point)
        self.landmarks_classification.append(obj_class)
